...
<main class="bg-white max-w-lg mx-auto p-8 my-10 rounded-lg shadow-2xl">
    <section>
        ...
        <p class="text-gray-600 pt2">Sign up to your account</p>
        <p>Sign in your account <a href="/login" class="text-purple-300 font-bold underline">here</a></p>
    </section>
    <section class="mt-10">
        <form action="/store" method="POST" class="flex flex-col">
            ...
            <div class="mb-6 pt-3 rounded bg-gray-200">
                ...
                <input type="name" name="name" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-400 px-3" value={{old('name')}}>
                @error('name')
